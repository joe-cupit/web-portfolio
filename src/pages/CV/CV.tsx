...
export default function CV() {
  ...
  return (
    <div className="cv-page">
      <header className="cv-left">
        <div className="cv-left-top">
          <h1 className="title">Joe Cupit</h1>
          <p className="subtitle">ML Software Developer</p>
          <p className="cv-left-desc">I am a Python developer specialising in AI and ML, with a passion for making websites.</p>
        
          <nav className="cv-left__nav">
            <ul>
        ...
        <div className="cv-left-bottom">
          <a href="https://github.com/joe-cupit" target="_blank">
          ...
          <a href="https://www.linkedin.com/in/joe-cupit/" target="_blank">
          ...
          <a href="mailto:jwcupit@gmail.com" target="_blank">
      ...
      <main className="cv-right">
        ...
        <div className="cv-right__bottom">
          Thanks for reading!
        </div>
      </main>
    </div>
